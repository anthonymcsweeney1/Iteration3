...
$stmt = $pdo->prepare("SELECT * FROM offer  ORDER BY OfferCode LIMIT :current_page, :record_per_page");
...
$num_contacts = $pdo->query("SELECT COUNT(*) FROM offer")->fetchColumn();
?>
    ...
    <div class="page-container">
        ...
        <div class="main-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h4 class="header-title mb-0">Offers</h4>
            ...
            <?php foreach ($offers as $offers): ?>
                                            ...
                                            <tr>
                                                <!-- Open OfferPage for that Offer Code -->
                                                <td><a href="OfferPage.php?OfferCode=<?=$offers['OfferCode']?>"><?=$offers['OfferCode']?></a></td>
                                                
                                                <td class=""><?=$offers['Customer']?></td>
                                                <td class=""><?=$offers['Earned']?></td>
                                                <td class=""><?=$offers['currency']?></td>
                                                <td class=""><?=$offers['start_date']?></td>
                                                <td class=""><?=$offers['end_date']?></td>
                                                <td class=""><?=$offers['status']?></td>
		...
		<?php if ($page > 1): ?>
		<a href="Offers.php?page=<?=$page-1?>"><i  <div class="icon-container">
