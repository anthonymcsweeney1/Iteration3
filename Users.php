...
$num_customers = $pdo->query("SELECT COUNT(*) FROM users")->fetchColumn();
?>
          ...
          <form action="" method="POST">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            <tr>
                                                <td class=""><b>User ID</b></td>
                                                <td class=""><b>Email</b></td>
                                               <td class=""><b>User Name</b></td>
                                                  <td class=""><b>Access</b></td>
            ...
            <?php foreach ($user as $user): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$user['id']?></a></td>
                                                 <td><a href="UserPage.php?ID=<?=$user['id']?>"><?=$user['user_name']?></td>
                                                <td><?=$user['name']?></td>
