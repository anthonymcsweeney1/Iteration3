...
if($_POST){
    ...
    try{
       ...
       // query to update claim
        $query = "UPDATE users 
                    SET user_name=:user_name, name=:name, User_Type=:User_Type
                    WHERE id = :id";
...
?>
 ...
 <div class="row">
     <div class="column_left"></div>
      ...
      <tr>
          ...
          <tr>
            <td>Username</td>
            <td><input type='text' name='user_name' readonly value="<?php echo htmlspecialchars($UserName, ENT_QUOTES);  ?>" class='form-control' /></td>
       </tr>
          <td>Name</td>
 ...
 <td>
     <input type='submit' id="Update" value='Update' class='btn btn-primary' />
                 &nbsp;&nbsp; 
                 <input type='submit' id="Delete" value='Delete' class='btn btn-primary' />
                  &nbsp;&nbsp; 
