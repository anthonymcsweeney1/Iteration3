                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    <li class="active"><a href="index.html">Invoice dashboard</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="index.html">View all Invoices</a></li>
                                    <li><a href="index3-horizontalmenu.html">Search Invoice</a></li>
                                    <li><a href="index3-horizontalmenu.html">Manually add an Invoice</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-pie-chart"></i><span>Claims</span></a>
                                <ul class="collapse">
                                    <li><a href="barchart.html">Search Claims</a></li>
                                    <li><a href="linechart.html">Create Claim</a></li>
                                  </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-palette"></i><span>Offers</span></a>
                                <ul class="collapse">
                                    <li><a href="accordion.html">Search Offer</a></li>
                                    <li><a href="alert.html">Create Offer</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="fontawesome.html">Search Customer</a></li>
                                    <li><a href="themify.html">On Boarding</a></li>
                                </ul>
                            </li>
            ...
            <div class="card"> 
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h4 class="header-title mb-0">No Claim Found</h4>
